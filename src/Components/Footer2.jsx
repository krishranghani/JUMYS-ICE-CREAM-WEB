...
function Footer2() {
  return (
    ...
    >
            ...
            <MDBCol className="mx-auto mb-4">
              ...
              <div className="">
                <input
                  ...
                  className="border-none w-full md:w-[70%] mt-5 rounded-full placeholder:pl-4 py-3"
                />
              </div>
              <div className="bg-[#e10914] hover:bg-gray-50 text-gray-50 hover:text-gray-950 flex justify-center items-center text-3xl text-center w-12 h-12 md:w-14 md:h-14 rounded-full mt-4">
                <FaArrowRight />
              </div>
            </MDBCol>
      ...
      <div className="border-t border-[#fbfafa] opacity-15"></div>

      <div className="pt-4 md:mt-0 flex flex-col md:flex-row justify-between items-center px-3">
        <div className="flex space-x-5 items-center py-7 md:py-4">
          <p className="text-sm md:text-base text-white text-center sm:text-left">
