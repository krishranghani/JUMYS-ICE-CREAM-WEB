  ...
  return (
    <div className="border-b border-gray-200 py-4">
      ...
      >
        ...
        <span className="text-lg sm:text-xl md:text-2xl font-bold">{isOpen ? '-' : '+'}</span>
      </div>
      {isOpen && <p className="mt-2 text-gray-600 text-sm sm:text-base md:text-lg">{answer}</p>}
    </div>
  );
};
...
const Faq2 = () => {
  ...
  return (
    <>
      <div className="max-w-xl sm:max-w-2xl md:max-w-4xl lg:max-w-6xl mx-auto my-8 px-4">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold font-serif mb-4 text-center">Frequently Asked Questions</h1>
