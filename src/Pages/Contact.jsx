  ...
  return (
    <>
      <div className="bg-gray-100">
        ...
        {/* <button
          onClick={scrollToTop}
          className={`fixed bottom-4 right-4 bg-red-500 text-white font-serif px-4 py-2 rounded-lg shadow-lg hover:bg-blue-700 transition-opacity duration-300 ${showScroll ? 'opacity-100' : 'opacity-0'}`}
        >
          Top
        </button> */}
        <Top />
